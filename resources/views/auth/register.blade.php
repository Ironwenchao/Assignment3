            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        {{ csrf_field() }}
                        <!--this is for name part, when the user is registering-->
                        ...
                        <!--this is for E-mail Address part, when the user is registering-->
                        ...
                        <!--this is for Confirm Password part, when the user is registering-->
